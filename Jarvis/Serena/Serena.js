...
Serena.prototype.start = function(username, userLname, nameknown, talk) {
	...
	while(Q !="done"){
		...
		if (Q==="What is my name?") {
			if (Q.indexOf('is my') >= 0) { 
					...
					if(nameknown===false){
					if(talk===true){
					say.speak("I do not know your name", 'Serena');
					}
					console.log();
					...
					if(nameknown===true){
					if(talk===true){
					say.speak("Your name is "+username+" "+userLname, 'Serena');
					}
					console.log();
		...
		if(Q==="how long have you existed?" || Q==="how long have you existed" || Q==="How long have you existed?" || Q==="How long have you existed" || Q==="how old are you" || Q==="How old are you?" || Q==="how old are you?"){
			...
			var d2 = new Date();
			console.log();
			say.speak("I have existed for", 'Serena');
			console.log("I have existed for");
			sleep(2500);
			say.speak(DateDiff.inDays(d1, d2)+" days, "+DateDiff.inWeeks(d1, d2)+" weeks, "+DateDiff.inMonths(d1, d2)+" months, and "+DateDiff.inYears(d1, d2)+" years.", 'Serena');
			...
			sleep(6000);
			say.speak("I was created on "+dString, 'Serena');
		...
		if(Q==="how many days until christmas?" || Q==="How many days until Christmas?" || Q==="how many days until christmas" || Q==="How many days until christmas" || Q==="How many more days until Christmas?"){
			...
			var d2 = new Date();
			console.log();
			say.speak("There are", 'Serena');
			console.log("There are");
			sleep(1);
			say.speak(DateDiff.inDays(d1, d2)*-1+" days until Christmas.", 'Serena');
		...
		if(Q==="how much information do you have stored?" || Q==="how much information do you have stored" || Q==="How much information do you have stored?" || Q==="How much information do you have stored" || Q==="how much information do you have?" || Q==="how much information do you have" || Q==="How much information do you have?"){
			console.log();
			say.speak("I have "+JSON.parse(questions.length+4)+" questions and answers stored.", 'Serena');
